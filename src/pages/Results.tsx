...
const toppers = [
  ...
  { name: "Karan Malhotra", rank: "AIR 5", exam: "CA Intermediate, Nov 2024", quote: "Best coaching institute for CA preparation. The doubt-solving sessions were incredibly helpful." },
  { name: "Sneha Reddy", rank: "AIR 7", exam: "CA Foundation, June 2024", quote: "I joined Pinnacle as an average student and came out as a topper. The transformation was incredible." },
  { name: "Arjun Nair", rank: "AIR 10", exam: "CMA Foundation, Dec 2024", quote: "The comprehensive study material and regular tests kept me on track throughout my preparation." },
  { name: "Meera Iyer", rank: "AIR 12", exam: "CA Final, May 2024", quote: "Pinnacle Academy doesn't just teach — they build your confidence to face the toughest exams." },
  { name: "Rahul Verma", rank: "AIR 15", exam: "CA Intermediate, Nov 2024", quote: "The online classes were just as good as offline. I could study from home without missing anything." },
];
      ...
      <section className="gradient-hero section-padding">
        <div className="container-main text-center">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0, transition: { delay: 0.1 } }} className="text-lg text-primary-foreground/80 max-w-2xl mx-auto">
            Celebrating the success of our students who achieved top ranks in CMA and CA examinations.
          </motion.p>
        </div>
      </section>
